 ...
 */
export async function getPODetailController(req: any, res: any) {
  try {
    ...
    const sortedPODetails = podList.sort(
      (a: any, b: any) => a.PO_DetailID - b.PO_DetailID,
    );
 ...
 */
export async function listPODetailsController(req: any, res: any) {
  try {
