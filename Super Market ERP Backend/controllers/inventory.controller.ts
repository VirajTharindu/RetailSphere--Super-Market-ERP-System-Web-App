...
// List Categories
export async function getAllCategoriesController(req: any, res: any) {
  try {
...
// Get Category by ID
export async function getCategoryByIdController(req: any, res: any) {
  try {
    const { id } = req.params;
...
export async function updateCategoryController(req: any, res: any) {
  try {
    const { id } = req.params;
    const { CategoryName, Description } = req.body;
